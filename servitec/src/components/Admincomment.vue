      ...
      axios
        ...
        .then((response) => {
          if (response.data && Array.isArray(response.data)) {
            ...
            console.error('Respuesta inesperada al obtener los comentarios:', response.data);
          }
        })
        .catch((error) => {
        ...
        axios
          ...
          .then((response) => {
            ...
            if (response.data.success) {
              ...
              alert('Error al eliminar el comentario: ' + (response.data.error || 'Error desconocido'));
            }
          })
          .catch((error) => {
